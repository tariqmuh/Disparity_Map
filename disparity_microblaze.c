 ...
 ******************************************************************************************/
#ifndef DEBUG
#define param_REF_ADDR  /* define the reference image address */
#define param_SCH_ADDR  /* define the search image address */
#define param_LV_ADDR   /* define the local variation matrix address */
#define param_SAD_ADDR  /* define the SAD matrix address */
#define param_DM_ADDR   /* define the DM matrix address */
#endif
